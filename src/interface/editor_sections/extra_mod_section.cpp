...
void ExtraModSection::resized() {
  ...
  int macro_row_height = 2 * knob_section_height - widget_margin + padding;
  int minimum_mod_height = 2 * knob_section_height - widget_margin;
  int desired_macro_height = vital::kNumMacros * macro_row_height - padding;
  int macro_height = jlimit(0, jmax(0, getHeight() - minimum_mod_height - padding), desired_macro_height);
