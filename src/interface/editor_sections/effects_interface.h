...
class EffectsInterface : public SynthSection, public DragDropEffectOrder::Listener,
  ...
  private:
    ...
    std::unique_ptr<SynthSection> utility_section_;
    std::unique_ptr<SynthSection> phase_shift_section_;
    std::unique_ptr<SynthSection> limiter_section_;
    std::unique_ptr<SynthSection> frequency_shifter_section_;
    std::unique_ptr<SynthSection> dimension_expander_section_;
