...
namespace vital {
  ...
  ReverbModule::ReverbModule(std::string prefix) : SynthModule(0, 1), reverb_(nullptr), prefix_(prefix) { }
  ...
  void ReverbModule::init() {
    ...
    Output* reverb_decay_time = createMonoModControl(prefix_ + "reverb_decay_time");
    Output* reverb_pre_low_cutoff = createMonoModControl(prefix_ + "reverb_pre_low_cutoff");
    Output* reverb_pre_high_cutoff = createMonoModControl(prefix_ + "reverb_pre_high_cutoff");
    Output* reverb_low_shelf_cutoff = createMonoModControl(prefix_ + "reverb_low_shelf_cutoff");
    Output* reverb_low_shelf_gain = createMonoModControl(prefix_ + "reverb_low_shelf_gain");
    Output* reverb_high_shelf_cutoff = createMonoModControl(prefix_ + "reverb_high_shelf_cutoff");
    Output* reverb_high_shelf_gain = createMonoModControl(prefix_ + "reverb_high_shelf_gain");
    Output* reverb_chorus_amount = createMonoModControl(prefix_ + "reverb_chorus_amount");
    Output* reverb_chorus_frequency = createMonoModControl(prefix_ + "reverb_chorus_frequency");
    Output* reverb_size = createMonoModControl(prefix_ + "reverb_size");
    Output* reverb_delay = createMonoModControl(prefix_ + "reverb_delay");
    Output* reverb_wet = createMonoModControl(prefix_ + "reverb_dry_wet");
