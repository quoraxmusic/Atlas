...
namespace vital {
  ...
  ChorusModule::ChorusModule(const Output* beats_per_second, std::string prefix) :
  ...
  void ChorusModule::init() {
    ...
    voices_ = createBaseControl(prefix_ + "chorus_voices");

    Output* free_frequency = createMonoModControl(prefix_ + "chorus_frequency");
    frequency_ = createTempoSyncSwitch(prefix_ + "chorus", free_frequency->owner, beats_per_second_, false);
    Output* feedback = createMonoModControl(prefix_ + "chorus_feedback");
    wet_output_ = createMonoModControl(prefix_ + "chorus_dry_wet");
    Output* cutoff = createMonoModControl(prefix_ + "chorus_cutoff");
    Output* spread = createMonoModControl(prefix_ + "chorus_spread");
    mod_depth_ = createMonoModControl(prefix_ + "chorus_mod_depth");

    delay_time_1_ = createMonoModControl(prefix_ + "chorus_delay_1");
    delay_time_2_ = createMonoModControl(prefix_ + "chorus_delay_2");
