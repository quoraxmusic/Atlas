...
namespace vital {
  ...
  CompressorModule::CompressorModule(std::string prefix) :
      SynthModule(0, kNumOutputs), compressor_(nullptr), prefix_(prefix) { }
  ...
  void CompressorModule::init() {
    ...
    Output* compressor_attack = createMonoModControl(prefix_ + "compressor_attack");
    Output* compressor_release = createMonoModControl(prefix_ + "compressor_release");
    Output* compressor_low_gain = createMonoModControl(prefix_ + "compressor_low_gain");
    Output* compressor_band_gain = createMonoModControl(prefix_ + "compressor_band_gain");
    Output* compressor_high_gain = createMonoModControl(prefix_ + "compressor_high_gain");

    Value* compressor_enabled_bands = createBaseControl(prefix_ + "compressor_enabled_bands");

    Value* compressor_low_upper_ratio = createBaseControl(prefix_ + "compressor_low_upper_ratio");
    Value* compressor_band_upper_ratio = createBaseControl(prefix_ + "compressor_band_upper_ratio");
    Value* compressor_high_upper_ratio = createBaseControl(prefix_ + "compressor_high_upper_ratio");
    Value* compressor_low_lower_ratio = createBaseControl(prefix_ + "compressor_low_lower_ratio");
    Value* compressor_band_lower_ratio = createBaseControl(prefix_ + "compressor_band_lower_ratio");
    Value* compressor_high_lower_ratio = createBaseControl(prefix_ + "compressor_high_lower_ratio");

    Value* compressor_low_upper_threshold = createBaseControl(prefix_ + "compressor_low_upper_threshold");
    Value* compressor_band_upper_threshold = createBaseControl(prefix_ + "compressor_band_upper_threshold");
    Value* compressor_high_upper_threshold = createBaseControl(prefix_ + "compressor_high_upper_threshold");
    Value* compressor_low_lower_threshold = createBaseControl(prefix_ + "compressor_low_lower_threshold");
    Value* compressor_band_lower_threshold = createBaseControl(prefix_ + "compressor_band_lower_threshold");
    Value* compressor_high_lower_threshold = createBaseControl(prefix_ + "compressor_high_lower_threshold");

    Output* compressor_mix = createMonoModControl(prefix_ + "compressor_mix");
