...
namespace vital {
  ...
  class ReorderableEffectChain : public SynthModule {
    public:
      ...
      ReorderableEffectChain(const Output* beats_per_second, const Output* keytrack, std::string prefix = "");
    ...
    protected:
      ...
      Value* effect_order_slots_[constants::kNumEffects];
      Value* post_effect_order_;
